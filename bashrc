...
export ZZPATH="/usr/local/bin/funcoeszz"  # script
source "$ZZPATH"
...
# Adicional PATH
PATH=$PATH:/home/$USER/Sync/programas/safe/

# Local aliases
if [ -f ~/local/etc/bashrc_aliases ]; then
    . ~/local/etc/bashrc_aliases
fi
